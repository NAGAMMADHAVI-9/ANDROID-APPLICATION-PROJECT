...
public class AttendanceReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        smonths = findViewById(R.id.spinner5);
    ...
    public void getReport(View view) {
       ...
       /* String todate = et_to.getText().toString();*/
        ...
        final String months = smonths.getSelectedItem().toString();
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot != null) {
                            ...
                            for (int i = 1; i <= 31; i++) {
                                ...
                                ssection.setSelection(0);
                                smonths.setSelection(0);
                                et_from.setText("");
                                /*Spinner sbr;
                                Spinner syear;
                                Spinner ssection;
